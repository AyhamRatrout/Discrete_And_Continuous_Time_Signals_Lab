...
subplot(3,1,1)
stem(n,y)
title('Plot of a discrete-time signal formed by computing the values of the function sin(t/6) at points which are uniformly spaced at intervals of size 2', 'Ayham Ratrout (arr90) and Kelsey Bare (khb35)');
